...
from feibot.agent.tools.path_guard import resolve_path


def _resolve_root(path: str | None, workspace_dir: Path) -> Path:
    """Resolve a search root, defaulting relative paths to the workspace."""
...
class FindFileTool(Tool):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        try:
            root_path = _resolve_root(root, self._base_dir)
