...
def _is_heartbeat_empty(content: str | None) -> bool:
    """Check whether HEARTBEAT.md has actionable content."""
    if not content:
        return True
...
class HeartbeatService:
    ...
    ``on_execute`` runs the task through the full agent loop and returns the
    response to deliver.
    """
    ...
    async def _decide(self, content: str) -> tuple[str, str]:
        """Ask LLM to decide skip/run via virtual heartbeat tool call."""
