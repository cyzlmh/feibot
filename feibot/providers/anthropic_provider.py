...
class AnthropicProvider(LLMProvider):
    ...
    @staticmethod
    def _parse_response(response: Any, *, requested_model: str | None = None) -> LLMResponse:
    ...
    async def chat(
        ...
        requested_model = self._strip_prefix(model or self.default_model)
        ...
        try:
            ...
            return self._parse_response(response, requested_model=requested_model)
